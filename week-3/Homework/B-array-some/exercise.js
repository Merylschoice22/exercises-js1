...
function isNull(pair) {
  console.log(pair === null);
  return pair === null;
}

pairsByIndex.forEach(isNull);

if (pairsByIndex.some(isNull)) {
  //  process.exit(1);
  console.log(`One of them is null. Guess which one it is...`)
}

// function containsNull(pairsByIndex) {
//   if (pairsByIndex.some(isNull)) {
//     process.exit(1);
//   }
// }

// containsNull(pairsByIndex);
